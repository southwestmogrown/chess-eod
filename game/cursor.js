...
class Cursor {
  ...
  selectMove() {
    if (!this.currentMove) {
      if (Screen.availableMoves && Screen.availableMoves.head) {
        this.currentMove = Screen.availableMoves.head;
      } else {
        return;
      }
    }
    ...
    this.currentMove = this.currentMove.next || Screen.availableMoves.head;
