...
class Board {
    ...
    generateBoard() {
        ...
        board[1][0] = new Square(0, 0, new Pawn());
        board[1][1] = new Square(0, 1, new Pawn());
        board[1][2] = new Square(0, 2, new Pawn());
        board[1][3] = new Square(0, 3, new Pawn());
        board[1][4] = new Square(0, 4, new Pawn());
        board[1][5] = new Square(0, 5, new Pawn());
        board[1][6] = new Square(0, 6, new Pawn());
        board[1][7] = new Square(0, 7, new Pawn());
